<template>
  <div class="side-menu-wrapper">
    <slot></slot>
    <Menu class="menu-uncollapsed" ref="menu" v-show="!collapsed" :active-name="activeName" :open-names="openedNames" :accordion="accordion" :theme="theme" width="auto" @on-select="handleSelect">
